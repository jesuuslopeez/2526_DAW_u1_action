...
### A - **Herramientas**  usadas para generar documentación.
 - La herramienta utilizda ha sido PDoc, la cuál genera documentos HTML a partir de los comentarios realizados en el código de Python.
### B - **Ejemplos de código documentado**
- https://github.com/jesuuslopeez/2526_DAW_u1_action/blob/edb1cae1f02ca5b247a645e858b044e71efbbeec/main.py#L1-L15
### C - **Formatos generados**
- He generado documentos únicamente en HTML, ya que he intentando reiteradamente hacerlo también en MarkDown sin conseguirlo en ningún caso.
### D - **Explicación breve** del _workflow_
- El workflow funciona de la siguiente manera:
	1. Se hace un checkout al repositorio.
	2. Se configura la versión 3.11 de Python.
	3. Se instala Pdoc.
	4. Genera la documentación en HTML.
	5. Se realiza un commit y un push.
### E - **Mensajes de  _commit_**
- *Add GitHub Actions workflow to greet in Spanish*
- *Delete .github/workflows/hello.yml*
- *Create docs.yml*
- *Cambio contenido main.py*
- *Update README con estado de tests*
### F - **Evidencia de configuración  SSH**
![Captura 1](assets/cap1.png)
### G - **Cómo clonar/usar**
...
### A - Identificación de herramientas de generación de documentación
 - Pdoc: Para generar la documentación en HTML de una manera visual y eficiente.
### B - Documentación de componentes
-https://github.com/jesuuslopeez/2526_DAW_u1_action/blob/edb1cae1f02ca5b247a645e858b044e71efbbeec/main.py#L1-L15
### C - Multiformato
- No he generado otro a parte de HTML, ya que no lo he conseguido, mi intención era hacer también MarkDown, pero no fue posible.
### D - Colaboración
...
- *Cambio contenido main.py*
- *Update README con estado de tests*
- Sí, son claros y descriptivos, ya que en pequeñas frases definen lo realizado correctamente.
